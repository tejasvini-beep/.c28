...
/*
  ...
  if(shooted === 1&&shooted!==2){
    text("You shooted Board 1, try shooting both next time",width - width/4,700)
  }
  if(shooted === 2&&shooted!==1){
    text("You shooted Board 2, try shooting both next time",width - width/4,700)
  }

  if(shooted ===3){
    text("You shooted Both-Boards yayyy champ!",width - width/4,700)
  }
  if(numberOfArrows ===0){
    text("play again n0w",width - width/6,100)
    isGameOver = true;
